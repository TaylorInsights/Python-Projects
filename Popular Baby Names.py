...
#The importance of renaming columns is to continue consistant patterns in code as well as naming conventions. I chose snake_case as it is my favorite way to reference code.
...
#After reviewing the data, clean the data as you see appropriate. For this cleaning step, you do not need to show all your work or interim results as you examine the data, 
#but you do need to show any commands you used to alter any of the data in the order you use them.
def group_ethnicities(df): #this definition combines duplications of ethnicity names that appear
...
df['Childs_First_Name'] = df['Childs_First_Name'].str.lower() #this makes sure the objects in Childs_First_Name are uniform

df_no_duplicates = df.drop_duplicates() #this drops any duplicate rows that appear
